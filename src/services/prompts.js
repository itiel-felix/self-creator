...
export const processedMainIdeaSystemPrompt = () => {
    return `
    You will receive a short scene idea describing something that could appear in a video.
    ...
    Examples: taxes -> money
    Examples: "make a bomb" -> "explosion"
    ...
    pouring
    breaking (if its a fragile object)
    slow motion  
    macro shot  
    ...
    - Avoid "something" in the description. Replace it with the specific thing in the idea or be creative.
        ...
        Example: "collecting something" -> "picking [something, replace with something in the idea]" -> "picking coins"
