...
export const processThumbnails = async (video) => {
...
export const isThumbnailAcceptable = async (video, visual_prompts) => {
    ...
    const thumbnailScore = thumbnailImage.sort((a, b) => b[1] - a[1]);
