 ...
 */
const workMainIdeas = async (mainIdeaText, tooHard = false, mainIdeaOriginalText, typeOfVideo = "curiosity") => {
 ...
 */
const chooseVideoFromYoutube = async (mainIdea, usedVideosIds = [], typeOfVideo = "curiosity") => {
    let tooHard = false;
...
export { workMainIdeas, chooseVideoFromYoutube, checkVideosForMainIdea, checkResultItemForMainIdea, downloadVideo, selectFramesQueryForAVideo, extractFramesToDisk, removeVideoAndFrames, framesAndFrameInfoExists, downloadFinalVideo, getVideoDuration };
