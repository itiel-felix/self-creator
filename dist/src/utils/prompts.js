export const mainIdeaSystemPrompt = (typeOfVideo = "curiosity") => {
...
export const processedMainIdeaSystemPrompt = (typeOfVideo = "curiosity") => {
    if (typeOfVideo === "videogame") {
        return `
...
export const searchQueriesSystemPrompt = (banned_terms = []) => {
    return `
