...
export const transcribeAudioWhisperX = async (audioPath) => {
    ...
    try {
        const response = await replicate.run("victor-upmeet/whisperx:84d2ad2d6194fe98a17d2b60bef1c7f910c46b2f6fd38996ca457afd9c8abfcb", {
            input: {
...
export const transcribeAudioWhisper = async (audioPath) => {
    ...
    const out = await replicate.run("openai/whisper:8099696689d249cf8b122d833c36ac3f75505c666a395ca40ef26f68e7d3d16e", {
        input: {
            audio: fileStream,
            transcription: "srt"
        },
    });
    fs.writeFileSync(cacheFile, JSON.stringify(out.transcription, null, 2));
